...
<head>
    ...
    <script src="https://cdn.jsdelivr.net/npm/popper.js@1.12.9/dist/umd/popper.min.js"
            ...
            crossorigin="anonymous"></script>
    <link rel="stylesheet" href="/assets/registerStyle.css.css">
                    ...
                    <div class="card" style="border-radius: 15px;">
                        <div class="card-body p-5">
                            ...
                            <form action="includes/register.php" method="post">
                                ...
                                <div data-mdb-input-init class="form-outline mb-4">
                                    <input type="text" id="form3Example3cg" class="form-control form-control-lg" name="mail" />
                                ...
                                <p class="text-center text-muted mt-5 mb-0">Have already an account? <a href="loginWidget.php"
